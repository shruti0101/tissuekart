...
<h2 className="capitalize  text-center text-black tracking-wide font-bold pt-8 text-3xl md:text-4xl">Trending collections</h2>
        ...
        {categories.map((slide) => (
          <SwiperSlide key={slide.id}>
            ...
            <div className="relative  rounded-xl overflow-hidden group">
              <Image  width={700}
                 height={700} src={slide.image} alt={slide.title}  className="object-contain md:object-cover" />
              <div className="absolute inset-0  bg-black/10" />
              <div className="absolute bottom-6 left-6 text-white z-10">
           
            
                
              <button className="px-3 py-2 bg-teal-700 md:mt-2  cursor-pointer rounded-md capitalize hover:bg-yellow-500">shop now</button>
              </div>
